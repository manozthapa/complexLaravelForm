  ...
  <form action="{{route('form.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
      ...
      <div class="col-third">
        ...
        <div class="col-third mm">
          <select name="dob_month_bs" class="form-control" >
            ...
            <option value="March" @if(old('dob_month_bs')=='Feburary') selected @endif>Ashad</option>
            <option value="April" @if(old('dob_month_bs')=='Feburary') selected @endif>Shrawan</option>
            <option value="May" @if(old('dob_month_bs')=='Feburary') selected @endif>May</option>
            <option value="June" @if(old('dob_month_bs')=='Feburary') selected @endif>June</option>
            <option value="July" @if(old('dob_month_bs')=='Feburary') selected @endif>July</option>
            <option value="August" @if(old('dob_month_bs')=='Feburary') selected @endif>August</option>
            <option value="September" @if(old('dob_month_bs')=='Feburary') selected @endif>September</option>
            <option value="October" @if(old('dob_month_bs')=='Feburary') selected @endif>October</option>
            <option value="November" @if(old('dob_month_bs')=='Feburary') selected @endif>November</option>
            <option value="December" @if(old('dob_month_bs')=='Feburary') selected @endif>December</option>
      ...
      <div class="col-third">
        ...
        <input type="text" name="ben_id_number" value="{{old('ben_id_number')}}" />
      </div>
      <div class="col-third">
    ...
    <div class="row">
      ...
      <div class="col-third">
        ...
        <input type="text" name="bank_branch_address" value="{{old('bank_branch_address')}}"  />
      </div>   
    </div>
    <hr>
    <div class="row">
